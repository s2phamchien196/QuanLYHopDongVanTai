...
namespace WindowsFormsApplication2
{
    public partial class Form1 : Form
    {
        ...
        {
            if (!checkTab("Quản lý bảng giá vận tải"))
            {
                QuanLyGiaXe usercontrol = new QuanLyGiaXe();
                usercontrol.Dock = DockStyle.Fill;
                TabFormItem tab = tabFormControl1.CreateTab("Quản lý bảng giá vận tải", "QLGX");
                tab.Panel.Controls.Add(usercontrol);
                tabFormControl1.SelectedTab = tab;
            }
        }
        ...
        {
            if (!checkTab("Thanh Toán hóa đơn"))
            {
                ThanhToan usercontrol = new ThanhToan();
                usercontrol.Dock = DockStyle.Fill;
                TabFormItem tab = tabFormControl1.CreateTab("Thanh Toán hóa đơn", "TTHD");
                tab.Panel.Controls.Add(usercontrol);
                tabFormControl1.SelectedTab = tab;
            }
        }
